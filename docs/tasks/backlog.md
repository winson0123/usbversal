...
| ~~`TASK-299`~~ | ~~Fix M4A hotcue / track colour~~ | Done — MP4 `markers` footer is unset track colour (`00 FF FF FF`); Markers2 `COLOR` is forced white. Rekordbox `#00C4FF` → `#0088CC` on M4A. |
